    ...
    <form action="#" method="post">
        <div id="leftpane">
            ...
            <div id="optionsContainer">
                <div id="opt1">
                    <img src="per.png" alt="#pinfo.php" width="40px">
                    <button name="pinf">Personal <br>Information</button>
                </div>
                <div id="opt2">
                    <img src="apimg.png" alt="#" width="40px">
                    <button name="showap">Applied <br> Post</button>
                </div>
                <div id="opt3">
                    <img src="jobp.jpg" alt="#" width="40px">
                    <a href="#" onclick="showheader()">Job <br> Posts</a>
                </div>
                <div id="opt4">
                    <img src="bmk.png" alt="#" width="40px">
                    <button name="bookmarks">Bookmarks</button>
                </div>
                <div id="opt5">
                    <img src="q1.png" alt="#" width="40px">
                    <button name="quer">Queries</button>
                </div>
                <div id="opt6">
                    <img src="joboffer.jpg" alt="#" width="40px">
